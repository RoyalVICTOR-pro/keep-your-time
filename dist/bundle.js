...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n //import Game from \"./Classes/class.game.js\";\n\nwindow.onload = function () {\n  var ACTIVITIES = [\"Rangement\", \"Travail\", \"Préparation\", \"Repas\", \"Jeu\", \"Dessin animé\"];\n  var FIRST_SELECT = document.getElementById('first-activity-list');\n  var FIRST_INPUT = document.getElementById('first-activity-time');\n  var SECOND_SELECT = document.getElementById('second-activity-list');\n  var SECOND_INPUT = document.getElementById('second-activity-time');\n  var FIRST_ACTIVITY_BACKGROUND = document.getElementById('first-activity');\n  var LOST_TIME = document.getElementById('lost-time');\n  var areFieldsVisible = true;\n  FIRST_ACTIVITY_BACKGROUND.addEventListener(\"click\", function (event) {\n    if (!areFieldsVisible) {\n      FIRST_SELECT.style.visibility = 'visible';\n      FIRST_INPUT.style.visibility = 'visible';\n      SECOND_SELECT.style.visibility = 'visible';\n      SECOND_INPUT.style.visibility = 'visible';\n    }\n  });\n  ACTIVITIES.forEach(function (element, key) {\n    FIRST_SELECT[key + 1] = new Option(element, element);\n    SECOND_SELECT[key + 1] = new Option(element, element);\n  });\n\n  FIRST_SELECT.onchange = function () {\n    var choice = FIRST_SELECT.selectedIndex;\n    var value = FIRST_SELECT.options[choice].value;\n    document.getElementById('first-activity-name').innerText = value;\n  };\n\n  SECOND_SELECT.onchange = function () {\n    var choice = SECOND_SELECT.selectedIndex;\n    var value = SECOND_SELECT.options[choice].value;\n    document.getElementById('second-activity-name').innerText = value;\n    launchTimer();\n  };\n\n  function launchTimer() {\n    FIRST_SELECT.style.visibility = 'hidden';\n    FIRST_INPUT.style.visibility = 'hidden';\n    SECOND_SELECT.style.visibility = 'hidden';\n    SECOND_INPUT.style.visibility = 'hidden';\n    areFieldsVisible = false;\n    var firstActivityDuration = parseInt(FIRST_INPUT.value);\n    var secondActivityDuration = parseInt(SECOND_INPUT.value);\n    var percentage = Math.floor(firstActivityDuration * 100 / (firstActivityDuration + secondActivityDuration));\n    FIRST_ACTIVITY_BACKGROUND.style.width = percentage + \"%\";\n    LOST_TIME.style.left = FIRST_ACTIVITY_BACKGROUND.offsetWidth + \"px\";\n    var tween = gsap.to(\"#chat-noir\", {\n      x: FIRST_ACTIVITY_BACKGROUND.offsetWidth,\n      duration: firstActivityDuration * 10,\n      ease: \"none\"\n    });\n    var tween2 = gsap.to(\"#chat-noir\", {\n      x: document.body.offsetWidth,\n      duration: secondActivityDuration * 10,\n      delay: firstActivityDuration * 10,\n      ease: \"none\"\n    });\n    var tween3 = gsap.to(\"#lost-time\", {\n      width: (document.body.offsetWidth - FIRST_ACTIVITY_BACKGROUND.offsetWidth).toString() + \"px\",\n      duration: secondActivityDuration * 10,\n      delay: firstActivityDuration * 10,\n      ease: \"none\"\n    });\n  }\n\n  this.console.log(\"C'est prêt en live reload !\");\n};\n\n//# sourceURL=webpack:///./src/main.js?");
