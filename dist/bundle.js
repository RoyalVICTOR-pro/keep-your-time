...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return TimerController; });\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../config */ \"./src/config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _views_class_lost_time_stopwatch_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../views/class.lost-time-stopwatch-view */ \"./src/Classes/views/class.lost-time-stopwatch-view.js\");\n/* harmony import */ var _views_class_won_time_marker_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../views/class.won-time-marker-view */ \"./src/Classes/views/class.won-time-marker-view.js\");\n/* harmony import */ var _views_class_timer_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../views/class.timer-view */ \"./src/Classes/views/class.timer-view.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\n\n\nvar TimerController = /*#__PURE__*/function () {\n  function TimerController() {\n    _classCallCheck(this, TimerController);\n\n    this.timerView = new _views_class_timer_view__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n    this.isRunning = false;\n    this.isFirstActivityFinished = false;\n  }\n\n  _createClass(TimerController, [{\n    key: \"prepare\",\n    value: function prepare(pUserChoices) {\n      this.userChoices = pUserChoices;\n      this.timerView.prepare(pUserChoices);\n      document.addEventListener(_config__WEBPACK_IMPORTED_MODULE_1___default.a.TIMER_VIEW_READY, this.timerIsReadyToLaunch.bind(this));\n      document.addEventListener(_config__WEBPACK_IMPORTED_MODULE_1___default.a.FIRST_ACTIVITY_ENDED, this.endFirstActivity.bind(this));\n    }\n  }, {\n    key: \"timerIsReadyToLaunch\",\n    value: function timerIsReadyToLaunch() {\n      var event = new CustomEvent(_config__WEBPACK_IMPORTED_MODULE_1___default.a.TIMER_READY_TO_LAUNCH_EVENT);\n      document.dispatchEvent(event);\n    }\n  }, {\n    key: \"start\",\n    value: function start() {\n      this.isRunning = true; // Ci-dessous, on prend le temps choisi par l'utilisateur qu'on multiplie par la durée des minutes configurée pour les tests,\n      // qu'on multiplie ensuite par 1000 pour avoir le temps en millisecondes\n      // et on y ajoute le \"delay\" de fermeture du popup\n      // avant le lancement de l'animation du curseur.\n\n      this.firstActivityTimer = setTimeout(this.firstActivityTimeIsOver.bind(this), this.userChoices.firstActivityDuration * _config__WEBPACK_IMPORTED_MODULE_1___default.a.MINUTE_DURATION * 1000 + _config__WEBPACK_IMPORTED_MODULE_1___default.a.POPUP_CLOSING_DELAY * 1000);\n      this.timerView.start();\n    }\n  }, {\n    key: \"firstActivityTimeIsOver\",\n    value: function firstActivityTimeIsOver() {\n      // Le temps prévu pour la première activité est écoulé\n      if (!this.isFirstActivityFinished) {\n        this.lostTimeStopWatchView = new _views_class_lost_time_stopwatch_view__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n        this.lostTimeStopWatchView.init(this.userChoices.secondActivityDuration);\n        this.lostTimeStopWatchView.start();\n      }\n    }\n  }, {\n    key: \"endFirstActivity\",\n    value: function endFirstActivity() {\n      // La première activité est terminée.\n      this.isFirstActivityFinished = true; // Si le chrono de dépassement existe, (donc que l'activité 1 a empiété sur l'activité 2)\n      // on coupe l'animation du chrono pour montrer le temps perdu.\n      // Sinon, on fait apparaître dans le fond une couleur montrant le temps gagné\n\n      if (this.lostTimeStopWatchView) {\n        this.lostTimeStopWatchView.pause();\n      } else {\n        this.wonTimeMarkerView = new _views_class_won_time_marker_view__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n        this.wonTimeMarkerView.show();\n      }\n    }\n  }, {\n    key: \"stopAllTimers\",\n    value: function stopAllTimers() {\n      if (this.lostTimeStopWatchView) {\n        this.lostTimeStopWatchView.kill();\n        this.lostTimeStopWatchView = null;\n      } else {\n        clearTimeout(this.firstActivityTimer);\n      }\n\n      if (this.wonTimeMarkerView) {\n        this.wonTimeMarkerView.kill();\n        this.wonTimeMarkerView = null;\n      }\n\n      this.isFirstActivityFinished = false;\n      this.isRunning = false;\n      this.timerView.showStopTimerButton();\n      this.timerView.stop();\n    }\n  }]);\n\n  return TimerController;\n}();\n\n\n\n//# sourceURL=webpack:///./src/Classes/controllers/class.timer-controller.js?");

/***/ }),

/***/ "./src/Classes/views/class.lost-time-stopwatch-view.js":
/*!*************************************************************!*\
  !*** ./src/Classes/views/class.lost-time-stopwatch-view.js ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return TimerView; });\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../config */ \"./src/config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_1__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar TimerView = /*#__PURE__*/function () {\n  function TimerView() {\n    _classCallCheck(this, TimerView);\n\n    // Elément(s) HTML manipulé(s)\n    this.htmlFirstActivityBackground = document.getElementById('first-activity-background');\n    this.htmlFirstActivityIcon = document.getElementById('first-activity-icon');\n    this.htmlFirstActivityName = document.getElementById('first-activity-name');\n    this.htmlStopTimerButton = document.getElementById('stop-timer-button');\n    this.htmlSecondActivityBackground = document.getElementById('second-activity-background');\n    this.htmlSecondActivityIcon = document.getElementById('second-activity-icon');\n    this.htmlSecondActivityName = document.getElementById('second-activity-name');\n    this.htmlCursor = document.getElementById('cursor');\n  }\n\n  _createClass(TimerView, [{\n    key: \"prepare\",\n    value: function prepare(pUserChoices) {\n      /* \r\n            Ici, on prépare le timer en fonction des choix de l'utilisateur. \r\n            On change les dimensions des fonds de couleurs, \r\n            on prépare l'animation du curseur sur la durée des 2 activités\r\n            */\n      this.userChoices = pUserChoices;\n      this.htmlFirstActivityIcon.src = _config__WEBPACK_IMPORTED_MODULE_1___default.a.ACTIVITIES_LIST[this.userChoices.firstActivityIndex].icon;\n      this.htmlSecondActivityIcon.src = _config__WEBPACK_IMPORTED_MODULE_1___default.a.ACTIVITIES_LIST[this.userChoices.secondActivityIndex].icon;\n      this.htmlFirstActivityName.innerHTML = _config__WEBPACK_IMPORTED_MODULE_1___default.a.ACTIVITIES_LIST[this.userChoices.firstActivityIndex].name;\n      this.htmlSecondActivityName.innerHTML = _config__WEBPACK_IMPORTED_MODULE_1___default.a.ACTIVITIES_LIST[this.userChoices.secondActivityIndex].name; // (Changement des proportions du fond : On fait les calculs sur une base de 90 car il y a des marges de chaque côté et le curseur court sur 90vw et non 100)\n\n      var backgroundSize = Math.floor(this.userChoices.firstActivityDuration * 90 / (this.userChoices.firstActivityDuration + this.userChoices.secondActivityDuration));\n      this.htmlFirstActivityBackground.style.width = backgroundSize + 'vw';\n      this.htmlSecondActivityBackground.style.width = 90 - backgroundSize + 'vw'; // Réglages des paramètres du curseur\n\n      this.cursorTween = gsap__WEBPACK_IMPORTED_MODULE_0__[\"gsap\"].timeline();\n      this.cursorTween.to(this.htmlCursor, {\n        x: this.htmlFirstActivityBackground.offsetWidth,\n        duration: this.userChoices.firstActivityDuration * _config__WEBPACK_IMPORTED_MODULE_1___default.a.MINUTE_DURATION,\n        ease: 'none'\n      });\n      this.cursorTween.to(this.htmlCursor, {\n        x: (this.htmlFirstActivityBackground.offsetWidth + this.htmlSecondActivityBackground.offsetWidth).toString() + 'px',\n        duration: this.userChoices.secondActivityDuration * _config__WEBPACK_IMPORTED_MODULE_1___default.a.MINUTE_DURATION,\n        ease: 'none'\n      }); // On affiche le bouton qui permet d'avertir que la première activité est terminée et qu'on passe à la 2ème.\n\n      this.htmlStopTimerButton.addEventListener(_config__WEBPACK_IMPORTED_MODULE_1___default.a.BUTTON_INTERACTION_EVENT, this.stopFirstActivity.bind(this));\n      this.showStopTimerButton();\n      var event = new CustomEvent(_config__WEBPACK_IMPORTED_MODULE_1___default.a.TIMER_VIEW_READY);\n      document.dispatchEvent(event);\n    }\n  }, {\n    key: \"start\",\n    value: function start() {\n      this.cursorTween.delay(_config__WEBPACK_IMPORTED_MODULE_1___default.a.POPUP_CLOSING_DELAY);\n      this.cursorTween.play();\n    }\n  }, {\n    key: \"stop\",\n    value: function stop() {\n      this.cursorTween.pause(0);\n    }\n  }, {\n    key: \"stopFirstActivity\",\n    value: function stopFirstActivity() {\n      this.hideStopTimerButton();\n      var event = new CustomEvent(_config__WEBPACK_IMPORTED_MODULE_1___default.a.FIRST_ACTIVITY_ENDED);\n      console.log('TimerView -> stopFirstActivity -> FIRST_ACTIVITY_ENDED', _config__WEBPACK_IMPORTED_MODULE_1___default.a.FIRST_ACTIVITY_ENDED);\n      document.dispatchEvent(event);\n    }\n  }, {\n    key: \"showStopTimerButton\",\n    value: function showStopTimerButton() {\n      this.htmlStopTimerButton.style.visibility = 'visible';\n    }\n  }, {\n    key: \"hideStopTimerButton\",\n    value: function hideStopTimerButton() {\n      this.htmlStopTimerButton.style.visibility = 'hidden';\n    }\n  }]);\n\n  return TimerView;\n}();\n\n\n\n//# sourceURL=webpack:///./src/Classes/views/class.timer-view.js?");

/***/ }),

/***/ "./src/Classes/views/class.won-time-marker-view.js":
/*!*********************************************************!*\
  !*** ./src/Classes/views/class.won-time-marker-view.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return WonTimeMarkerView; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar WonTimeMarkerView = /*#__PURE__*/function () {\n  function WonTimeMarkerView(pSecondActivityBackground, pSecondActivityDuration) {\n    _classCallCheck(this, WonTimeMarkerView);\n\n    // Element(s) HTML manipulé(s)\n    this.htmlWonTime = document.getElementById('won-time');\n    this.htmlCursor = document.getElementById('cursor');\n    this.htmlFirstActivityBackground = document.getElementById('first-activity-background');\n  }\n\n  _createClass(WonTimeMarkerView, [{\n    key: \"show\",\n    value: function show() {\n      this.htmlWonTime.style.left = this.htmlCursor.getBoundingClientRect().left + this.htmlCursor.offsetWidth / 2 + 'px';\n      this.htmlWonTime.style.width = this.htmlFirstActivityBackground.offsetWidth - this.htmlCursor.getBoundingClientRect().left + 'px';\n    }\n  }, {\n    key: \"kill\",\n    value: function kill() {\n      this.htmlWonTime.style.width = 0;\n    }\n  }]);\n\n  return WonTimeMarkerView;\n}();\n\n\n\n//# sourceURL=webpack:///./src/Classes/views/class.won-time-marker-view.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config */ \"./src/config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _Classes_controllers_class_timer_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Classes/controllers/class.timer-controller */ \"./src/Classes/controllers/class.timer-controller.js\");\n/* harmony import */ var _Classes_class_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Classes/class.form */ \"./src/Classes/class.form.js\");\n\n\n\n\n\n\nwindow.onload = function () {\n  // Initialisation\n  var appForm = new _Classes_class_form__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n  var appTimer = new _Classes_controllers_class_timer_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"](); // On affiche le formulaire\n\n  appForm.init();\n  appForm.show(); // On attend que le formulaire soit rempli, validé et vérifié pour préparer le timer.\n\n  document.addEventListener(_config__WEBPACK_IMPORTED_MODULE_2___default.a.TIMER_DATA_READY_EVENT, prepareTimer);\n\n  function prepareTimer(e) {\n    if (appTimer.isRunning) {\n      appTimer.stopAllTimers();\n    }\n\n    appTimer.prepare(e.detail.userChoices); // On attend que le timer soit prêt en arrière-plan pour masquer le formulaire et lancer le timer\n\n    document.addEventListener(_config__WEBPACK_IMPORTED_MODULE_2___default.a.TIMER_READY_TO_LAUNCH_EVENT, launchTimer(e));\n  }\n\n  function launchTimer(e) {\n    appForm.hide();\n    appTimer.start();\n  }\n};\n\n//# sourceURL=webpack:///./src/main.js?");
